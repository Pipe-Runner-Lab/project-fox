This repository has been archieved as we move to a more focused code-base with concentration on the pixel art tool itself rather than the entire application.
